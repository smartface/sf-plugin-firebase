 ...
 * @enum {string}
 */
declare namespace FirebaseAnalyticsEvent {
     ...
     * <li>FirebaseAnalytics.Param.TRAVEL_CLASS (String)  for travel bookings</li></ul>
     */
    const ECOMMERCE_PURCHASE: "ecommerce_purchase";
     ...
     * <li>FirebaseAnalytics.Param.ITEM_LOCATION_ID (String)</li></ul>
     */
    const PRESENT_OFFER: "present_offer";
     ...
     */
    const PURCHASE_REFUND: "purchase_refund";
